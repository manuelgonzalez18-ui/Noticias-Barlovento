...
Poner `dry-run: true` en el workflow, hacer push, y revisar el log en la pestaña
Actions. Muestra qué archivos subiría sin tocar nada. Cuando la ruta se vea
correcta, volver a `false`.
